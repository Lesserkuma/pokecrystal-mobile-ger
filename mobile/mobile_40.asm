...
Function10107d:
	...
	; FriendDataStructure.txt: name +0, big-endian TID +$0b, nicknames
	; +$0d, OT names +$4f, and 0x30-byte party structs +$91.
	; wd271 aliases the start of the enemy-party union (the trainer name), so
	; using it as an ID produced the first two name bytes instead of the TID.
	ld hl, wOTPlayerName
	ld de, wc608
	ld bc, NAME_LENGTH
	call CopyBytes
